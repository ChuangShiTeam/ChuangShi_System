...
class ImageCrop extends Component {
    ...
    componentDidMount() {
        notification.on('notification_image_crop_' + this.props.name + '_show', this, function (data) {
            this.setState({
                is_show: true
            });
        });
    ...
    componentWillUnmount() {
        notification.remove('notification_image_crop_' + this.props.name + '_show', this);
    }
            ...
            <Modal title={'裁剪图片'} maskClosable={false} width={document.documentElement.clientWidth - 200}
                   ...
                   footer={[
                       <div key="normal" style={{float: 'left', marginLeft: 10}} className="crop-button">
                           <Icon type="cloud-upload" style={{marginRight: 5}}/><input type="file"
                                                                                      onChange={this.handleChange.bind(this)}/>选择图片
                       </div>,
