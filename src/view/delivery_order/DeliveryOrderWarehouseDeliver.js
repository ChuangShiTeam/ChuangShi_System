...
class DeliveryOrderWarehouseDeliver extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        notification.on('notification_delivery_order_warehouse_deliver', this, function (data) {
            this.setState({
                is_show: true,
    ...
    componentWillUnmount() {
        notification.remove('notification_delivery_order_warehouse_deliver', this);
                                ...
                                <FormItem hasFeedback {...{
                                ...
                                }} className="form-item" label="发货金额">
                                    {
                                        getFieldDecorator('member_delivery_order_amount', {
                                            ...
                                            <InputNumber min={0} placeholder={constant.placeholder + '发货金额'} onPressEnter={this.handleSubmit.bind(this)} disabled={this.state.delivery_order_is_pay}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
...
DeliveryOrderWarehouseDeliver.propTypes = {};

DeliveryOrderWarehouseDeliver = Form.create({})(DeliveryOrderWarehouseDeliver);

export default DeliveryOrderWarehouseDeliver;