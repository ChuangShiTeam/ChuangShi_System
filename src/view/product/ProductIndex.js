...
class ProductIndex extends Component {
    ...
    handleLoad() {
        ...
        http.request({
            url: '/product/' + constant.action + '/list',
            data: {
                app_id: this.props.product.app_id,
                product_name: this.props.product.product_name,
    ...
    handleAdd() {
        notification.emit('notification_product_detail_add', {});
    }

    handleEdit(product_id) {
        notification.emit('notification_product_detail_edit', {
    ...
    handleDel(product_id, system_version) {
        ...
        http.request({
            url: '/product/' + constant.action + '/delete',
            data: {
                product_id: product_id,
