...
class AppStockInDetail extends Component {
	constructor(props) {
		super(props);
	...
	componentDidMount() {
		notification.on('notification_app_stock_in_detail_view', this, function (data) {
			this.setState({
				is_show: true,
	...
	componentWillUnmount() {
		notification.remove('notification_app_stock_in_detail_view', this);
	}
...
AppStockInDetail.propTypes = {};

AppStockInDetail = Form.create({})(AppStockInDetail);

export default connect(({app_stock_in}) => ({app_stock_in}))(AppStockInDetail);