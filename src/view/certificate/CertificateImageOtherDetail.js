...
class CertificateImageOtherDetail extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        notification.on('notification_certificate_image_other_detail_add', this, function (data) {
            this.setState({
                is_show: true,
                action: 'save',
                type: data.type,
        ...
        notification.on('notification_certificate_image_other_detail_edit', this, function (data) {
            this.setState({
                is_show: true,
                action: 'update',
    ...
    componentWillUnmount() {
        notification.remove('notification_certificate_image_other_detail_add', this);

        notification.remove('notification_certificate_image_other_detail_edit', this);
    }
    ...
    handleSubmit() {
        this.props.form.validateFieldsAndScroll((errors, values) => {
            ...
            http.request({
                url: '/certificate/image/other/' + constant.action + '/' + this.state.action,
                data: values,
                success: function (data) {
...
CertificateImageOtherDetail.propTypes = {};

CertificateImageOtherDetail = Form.create({})(CertificateImageOtherDetail);

export default connect(({certificate_image}) => ({certificate_image}))(CertificateImageOtherDetail);