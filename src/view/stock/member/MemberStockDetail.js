...
class MemberStockDetail extends Component {
    ...
    componentDidMount() {
        notification.on('notification_member_stock_detail_add', this, function (data) {
            this.setState({
                is_show: true,
                action: 'save'
            });
        ...
        notification.on('notification_member_stock_detail_edit', this, function (data) {
            this.setState({
                is_show: true,
                action: 'update',
    ...
    componentWillUnmount() {
        notification.remove('notification_member_stock_detail_add', this);

        notification.remove('notification_member_stock_detail_edit', this);
    }
