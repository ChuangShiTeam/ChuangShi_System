...
class XietongSignupJuniorDetail extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        notification.on('notification_xietong_signup_junior_detail_add', this, function (data) {
            this.setState({
                is_show: true,
                action: 'save'
            });
        ...
        notification.on('notification_xietong_signup_junior_detail_edit', this, function (data) {
            this.setState({
                is_show: true,
                action: 'update',
    ...
    componentWillUnmount() {
        notification.remove('notification_xietong_signup_junior_detail_add', this);

        notification.remove('notification_xietong_signup_junior_detail_edit', this);
    }
        ...
        http.request({
            ...
            success: function (data) {
                ...
                this.props.form.setFieldsValue({
                    ...
                    job: data.job,
                    primary_school_class: data.primary_school_class,
    ...
    handleSubmit() {
        this.props.form.validateFieldsAndScroll((errors, values) => {
            ...
            http.request({
                url: '/' + constant.action + '/xietong/signup/junior/' + this.state.action,
                data: values,
                success: function (data) {
                    message.success(constant.success);

                    notification.emit('notification_xietong_signup_junior_index_load', {});
                        ...
                        <Row>
                            <Col span={8}>
                                <FormItem hasFeedback {...{
                                    labelCol: {span: 6},
                                    wrapperCol: {span: 18}
                                }} className="form-item" label="担任职务">
                                    {
                                        getFieldDecorator('job', {
                                            ...
                                            <Input type="text" placeholder={constant.placeholder + '担任职务'} onPressEnter={this.handleSubmit.bind(this)}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span={8}>
                                <FormItem hasFeedback {...{
                                    labelCol: {span: 6},
                                    wrapperCol: {span: 18}
                                }} className="form-item" label="原就读小学所在班级">
                                    {
                                        getFieldDecorator('primary_school_class', {
                                            rules: [{
                                                required: true,
                                                message: constant.required
                                            }],
                                            ...
                                            <Input type="text" placeholder={constant.placeholder + '原就读小学所在班级'} onPressEnter={this.handleSubmit.bind(this)}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span={8}>
                                <FormItem hasFeedback {...{
                                    labelCol: {span: 6},
                                    wrapperCol: {span: 18}
                                }} className="form-item" label="原就读小学">
                                    {
                                        getFieldDecorator('primary_school', {
                                            ...
                                            <Input type="text" placeholder={constant.placeholder + '原就读小学'} onPressEnter={this.handleSubmit.bind(this)}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span={8}>
                                <FormItem hasFeedback {...{
                                    labelCol: {span: 6},
                                    wrapperCol: {span: 18}
                                }} className="form-item" label="数据分数">
                                    {
                                        getFieldDecorator('math_score', {
                                            rules: [{
                                                required: true,
                                                message: constant.required
                                            }],
                                            ...
                                            <Input type="text" placeholder={constant.placeholder + '数据分数'} onPressEnter={this.handleSubmit.bind(this)}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span={8}>
                                <FormItem hasFeedback {...{
                                    labelCol: {span: 6},
                                    wrapperCol: {span: 18}
                                }} className="form-item" label="英语成绩">
                                    {
                                        getFieldDecorator('english_score', {
                                            rules: [{
                                                required: true,
                                                message: constant.required
                                            }],
                                            ...
                                            <Input type="text" placeholder={constant.placeholder + '英语成绩'} onPressEnter={this.handleSubmit.bind(this)}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span={8}>
                                <FormItem hasFeedback {...{
                                    labelCol: {span: 6},
                                    wrapperCol: {span: 18}
                                }} className="form-item" label="语文成绩">
                                    {
                                        getFieldDecorator('chinese_score', {
                                            rules: [{
                                                required: true,
                                                message: constant.required
                                            }],
                                            ...
                                            <Input type="text" placeholder={constant.placeholder + '语文成绩'} onPressEnter={this.handleSubmit.bind(this)}/>
                                        )
                                    }
                                </FormItem>
                            </Col>
...
XietongSignupJuniorDetail.propTypes = {};

XietongSignupJuniorDetail = Form.create({})(XietongSignupJuniorDetail);

export default connect(({xietong_signup_junior}) => ({xietong_signup_junior}))(XietongSignupJuniorDetail);